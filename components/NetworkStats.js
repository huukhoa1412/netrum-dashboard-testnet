  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard icon="📈" title="Total Nodes" value={stats?.total_nodes || 'N/A'} color="blue" />
        <StatCard icon="✅" title="Active Nodes" value={stats?.active_nodes || 'N/A'} color="green" />
        <StatCard icon="🌐" title="Online Nodes" value={stats?.online_nodes || 'N/A'} color="purple" />
        <StatCard icon="⛏️" title="Mining Now" value={stats?.mining_nodes || 'N/A'} color="yellow" />
      </div>
